...
void init_arrays(DATA_TYPE* data)
{
  ...
  #pragma acc data pcopy(data[0:1050624])
  #pragma acc kernels
...
void CPU__correlation(DATA_TYPE* data, DATA_TYPE* mean, DATA_TYPE* stddev, DATA_TYPE* symmat)
{
  ...
  #pragma acc data pcopy(data[1026:1049598],mean[1:1023])
  #pragma acc kernels
  #pragma acc loop independent
  for (j = 1; j < (M+1); j++)
    {
  ...
  #pragma acc data pcopy(data[1026:1049598],mean[1:1023],stddev[1:1023])
  #pragma acc kernels
  #pragma acc loop independent
  for (j = 1; j < (M+1); j++)
    {
  ...
  #pragma acc data pcopy(data[1026:1049598],symmat[1026:1049597])
  #pragma acc kernels
  #pragma acc loop independent
  for (j1 = 1; j1 < M; j1++)
    {	
...
void GPU__correlation(DATA_TYPE* data, DATA_TYPE* mean, DATA_TYPE* stddev, DATA_TYPE* symmat)
{
  ...
  // Determine mean of column vectors of input data matrix 
  //Maps data once.
#pragma acc data pcopy(data[1026:1050624],mean[1:1024])
#pragma acc kernels
#pragma acc loop independent
	  #pragma acc data pcopy(data[1026:1049598],mean[1:1023])
	  #pragma acc kernels
    ...
    // Determine standard deviations of column vectors of data matrix. 
	  #pragma acc data pcopy(data[1026:1050624],mean[1:1024],stddev[1:1024])
	  #pragma acc kernels
	  #pragma acc loop independent
	  #pragma acc data pcopy(data[1026:1049598],mean[1:1023],stddev[1:1023])
	  #pragma acc kernels
	  ...
	  // Calculate the m * m correlation matrix. 
	  #pragma acc data pcopy(data[1026:1050624],symmat[1026:1050623])
	  #pragma acc kernels
	  #pragma acc loop independent
	  #pragma acc data pcopy(data[1026:1049598],symmat[1026:1049597])
	  #pragma acc kernels
...
void compareResults(DATA_TYPE* symmat, DATA_TYPE* symmat_outputFromGpu)
{
  ...
  #pragma acc data pcopy(symmat[1026:1049598],symmat_outputFromGpu[1026:1049598])
  #pragma acc kernels
  #pragma acc loop independent
  for (i=1; i < (M+1); i++)
    {
