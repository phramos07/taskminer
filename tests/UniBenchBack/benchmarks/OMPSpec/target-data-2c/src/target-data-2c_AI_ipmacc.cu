...
void init_again(DATA_TYPE * A, DATA_TYPE * B)
{
  ...
  __global__ void __generated_kernel_region_0(DATA_TYPE * A,DATA_TYPE * B);
 
void GPU__init_again(DATA_TYPE * A, DATA_TYPE * B)
{
  int i;
...
void CPU__vec_mult(DATA_TYPE* A, DATA_TYPE* B, DATA_TYPE* C)
{
  ...
  __global__ void __generated_kernel_region_1(DATA_TYPE * A,DATA_TYPE * B,DATA_TYPE * C);
 
  __global__ void __generated_kernel_region_2(DATA_TYPE * A,DATA_TYPE * B,DATA_TYPE * C);
