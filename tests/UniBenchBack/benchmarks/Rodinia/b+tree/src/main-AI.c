...
void compareResults(long *offset_cpu, long *offset_gpu, long *currKnode_cpu, long *currKnode_gpu, record *ans_cpu, record *ans_gpu, count) {
  ...
  AI1[4] = 4 * AI1[1];
  AI1[5] = AI1[4] / 4;
  #pragma acc data copy(offset_cpu[0:AI1[3]],offset_gpu[0:AI1[3]],currKnode_cpu[0:AI1[3]],currKnode_gpu[0:AI1[3]],ans_cpu[0:AI1[5]],ans_gpu[0:AI1[5]])
  #pragma acc kernels
	  ...
	  commandPointer++;
		switch (instruction) {
			...
			case 'k':
			{
				...
				AI9[2] = 4 * AI9[1];
				AI9[3] = AI9[2] / 4;
				#pragma acc data copy(_tmp[0:AI9[3]])
				#pragma acc kernels
				#pragma acc loop independent
				for(i = 0; i < count; i++){
				...
				long long int AI10[4];
				AI10[0] = count > 0;
				AI10[1] = (AI10[0] ? count : 0);
				AI10[2] = 4 * AI10[1];
				AI10[3] = AI10[2] / 4;
				#pragma acc data copy(_tmp[0:AI10[3]])
				#pragma acc kernels
				#pragma acc loop independent
				for(i = 0; i < count; i++){
					ans_cpu[i].value = -1;
				...
				// OUTPUT: ans CPU initialization
				long long int AI11[4];
				AI11[0] = count > 0;
				AI11[1] = (AI11[0] ? count : 0);
				AI11[2] = 4 * AI11[1];
				AI11[3] = AI11[2] / 4;
				#pragma acc data copy(_tmp[0:AI11[3]])
				#pragma acc kernels
				#pragma acc loop independent
				for(i = 0; i < count; i++){
					ans_gpu[i].value = -1;
			...
			case 'j':
			{
				...
				int i;
				long long int AI12[4];
				AI12[0] = count > 0;
				AI12[1] = (AI12[0] ? count : 0);
				AI12[2] = 4 * AI12[1];
				AI12[3] = AI12[2] / 4;
				#pragma acc data copy(_tmp[0:AI12[3]],_tmp[0:AI12[3]])
				#pragma acc kernels
				#pragma acc loop independent
				for(i = 0; i < count; i++){
				...
				// OUTPUT: ans CPU initialization
				long long int AI13[4];
				AI13[0] = count > 0;
				AI13[1] = (AI13[0] ? count : 0);
				AI13[2] = 4 * AI13[1];
				AI13[3] = AI13[2] / 4;
				#pragma acc data copy(_tmp[0:AI13[3]],_tmp[0:AI13[3]])
				#pragma acc kernels
				#pragma acc loop independent
				for(i = 0; i < count; i++){
					recstart[i] = 0;
