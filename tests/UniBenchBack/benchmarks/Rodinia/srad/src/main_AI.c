...
int main(int argc, char *argv[]) {
  ...
  #pragma omp single
  for (i = 0; i < Nr; i++) {
    long long int TM200[7];
    TM200[0] = Nr > 0;
    TM200[1] = (TM200[0] ? Nr : 0);
    TM200[2] = 4 * TM200[1];
    TM200[3] = TM200[2] + 1;
    TM200[4] = TM200[3] / 4;
    TM200[5] = (TM200[4] > 0);
    TM200[6] = (TM200[5] ? TM200[4] : 0);
    int tm_cost4 = (23);
    #pragma omp task depend(inout: iN[0:TM200[6]],iS[0:TM200[6]]) if(tm_cost4 > 1000)
    {
    long long int TM200[7];
    TM200[0] = Nr > 0;
    TM200[1] = (TM200[0] ? Nr : 0);
  ...
  #pragma omp single
  for (j = 0; j < Nc; j++) {
    long long int TM199[7];
    TM199[0] = Nc > 0;
    TM199[1] = (TM199[0] ? Nc : 0);
    TM199[2] = 4 * TM199[1];
    TM199[3] = TM199[2] + 1;
    TM199[4] = TM199[3] / 4;
    TM199[5] = (TM199[4] > 0);
    TM199[6] = (TM199[5] ? TM199[4] : 0);
    int tm_cost3 = (23);
    #pragma omp task depend(inout: jE[0:TM199[6]],jW[0:TM199[6]]) if(tm_cost3 > 1000)
    {
    long long int TM199[7];
    TM199[0] = Nc > 0;
    TM199[1] = (TM199[0] ? Nc : 0);
  ...
  for (i = 0; i < Ne; i++) { // do for the number of elements in input IMAGE
    long long int TM198[8];
    TM198[0] = Nc * Nr;
    TM198[1] = TM198[0] > 0;
    TM198[2] = (TM198[1] ? TM198[0] : 0);
    TM198[3] = 4 * TM198[2];
    TM198[4] = TM198[3] + 1;
    TM198[5] = TM198[4] / 4;
    TM198[6] = (TM198[5] > 0);
    TM198[7] = (TM198[6] ? TM198[5] : 0);
    int tm_cost2 = (44);
    #pragma omp task depend(inout: image[0:TM198[7]],image_cpu[0:TM198[7]]) if(tm_cost2 > 1000)
    {
    long long int TM198[8];
    TM198[0] = Nc * Nr;
    TM198[1] = TM198[0] > 0;
...
#pragma omp parallel for collapse(2)
  ...
  for (i = 0; i < Ne; i++) {        // do for the number of elements in IMAGE
    long long int TM195[8];
    TM195[0] = Nc * Nr;
    TM195[1] = TM195[0] > 0;
    TM195[2] = (TM195[1] ? TM195[0] : 0);
    TM195[3] = 4 * TM195[2];
    TM195[4] = TM195[3] + 1;
    TM195[5] = TM195[4] / 4;
    TM195[6] = (TM195[5] > 0);
    TM195[7] = (TM195[6] ? TM195[5] : 0);
    int tm_cost1 = (44);
    #pragma omp task depend(inout: image[0:TM195[7]],image_cpu[0:TM195[7]]) if(tm_cost1 > 1000)
    {
    long long int TM195[8];
    TM195[0] = Nc * Nr;
    TM195[1] = TM195[0] > 0;
