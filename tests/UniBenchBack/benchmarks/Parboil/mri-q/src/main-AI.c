...
void compareResults(DATA_TYPE *A, DATA_TYPE *A_GPU, DATA_TYPE *B, DATA_TYPE *B_GPU)
{
  ...
  AI1[2] = 4 * AI1[1];
  AI1[3] = AI1[2] / 4;
  #pragma acc data copy(A[0:AI1[3]],A_GPU[0:AI1[3]])
  #pragma acc kernels
  ...
  AI2[2] = 4 * AI2[1];
  AI2[3] = AI2[2] / 4;
  #pragma acc data copy(B[0:AI2[3]],B_GPU[0:AI2[3]])
  #pragma acc kernels
  #pragma acc loop independent
  for (i=0; i < N; i++)
    {
...
//  pb_SwitchToTimer(&timers, pb_TimerID_COMPUTE);
  ...
  AI1[7] = 4 + AI1[4];
  AI1[8] = AI1[7] > AI1[4];
  AI1[9] = (AI1[8] ? AI1[7] : AI1[4]);
  AI1[10] = AI1[6] > AI1[9];
  AI1[11] = (AI1[10] ? AI1[6] : AI1[9]);
  AI1[12] = AI1[5] > AI1[11];
  AI1[13] = (AI1[12] ? AI1[5] : AI1[11]);
  AI1[14] = AI1[13] / 16;
  #pragma acc data copy(kx[0:AI1[3]],ky[0:AI1[3]],kz[0:AI1[3]],phiMag[0:AI1[3]],kVals[0:AI1[14]])
  #pragma acc kernels
  #pragma acc loop independent
  for (k = 0; k < numK; k++) {
    kVals[k].Kx = kx[k];
