...
#ifndef ISPC_OBJS_DFS_ISPC_H
#define ISPC_OBJS_DFS_ISPC_H
...
extern "C" {
    ...
    extern void graph_dfs(struct Graph &graph, int32_t root, float * f);
    extern void graph_dfs_par(struct Graph &graph, int32_t root, float * f);
