...
CXX=clang++
CXXFLAGS+=$(LDP_HPP) -I objs/ -O2 -std=c++11
CC=clang
CCFLAGS+=$(LDP_HPP) -I objs/ -O2

LIBS=-lm $(TASK_LIB) -lstdc++
ISPC=ispc
ISPC_FLAGS+=-O2 -I $(LDP_SRC)
...
OBJS=$(TASK_OBJ) $(ISPC_OBJS)

all: $(EXAMPLE)-seq $(EXAMPLE)-ldp $(EXAMPLE)-par 
...
clean:
	/bin/rm -rf objs *~ $(EXAMPLE)-seq $(EXAMPLE)-ldp $(EXAMPLE)-par $(EXAMPLE)-lch $(EXAMPLE)-sse4 $(EXAMPLE)-generic16 ref test
...
$(TASK_OBJ): $(TASK_CXX) dirs $(ISPC_HEADER)
	$(CXX) $< $(CXXFLAGS) -c -o $@
...
objs/$(EXAMPLE)-ldp.o: objs/$(EXAMPLE)_ispc.h dirs

objs/$(EXAMPLE)-lch.o: objs/$(EXAMPLE)_ispc.h dirs

objs/$(EXAMPLE)-par.o: objs/$(EXAMPLE)_ispc.h dirs
