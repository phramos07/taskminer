...
// Determine mean of column vectors of input data matrix
  ...
  || (mean + 1 > data + 16511));
  #pragma acc data pcopyin(data[130:16511]) pcopy(mean[1:128]) if(!RST_AI1)
  {
  ...
  || (stddev + 1 > mean + 128));
  #pragma acc data pcopyin(data[130:16511],mean[1:128]) pcopy(stddev[1:128]) if(!RST_AI2)
  {
  ...
  || (stddev + 1 > mean + 128));
  #pragma acc data pcopyin(mean[1:128],stddev[1:128]) pcopy(data[130:16511]) if(!RST_AI3)
  {
...
// Calculate the m * m correlation matrix.
  ...
  #pragma acc data pcopyin(data[130:16511]) pcopy(symmat[130:16510]) if(!RST_AI4)
  {
