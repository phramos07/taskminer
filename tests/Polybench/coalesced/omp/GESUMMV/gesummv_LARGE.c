...
#pragma omp parallel for
  ...
  || (B + 0 > A + 4194304));
  RST_AI1 |= !((A + 0 > tmp + 2048)
  || (tmp + 0 > A + 4194304));
  RST_AI1 |= !((A + 0 > x + 2048)
  || (x + 0 > A + 4194304));
  RST_AI1 |= !((A + 0 > y + 2048)
  || (y + 0 > A + 4194304));
  RST_AI1 |= !((B + 0 > tmp + 2048)
  || (tmp + 0 > B + 4194304));
  RST_AI1 |= !((B + 0 > x + 2048)
  || (x + 0 > B + 4194304));
  RST_AI1 |= !((B + 0 > y + 2048)
  || (y + 0 > B + 4194304));
  RST_AI1 |= !((tmp + 0 > x + 2048)
  || (x + 0 > tmp + 2048));
  RST_AI1 |= !((tmp + 0 > y + 2048)
  || (y + 0 > tmp + 2048));
  RST_AI1 |= !((x + 0 > y + 2048)
  || (y + 0 > x + 2048));
  #pragma omp target data map(to: A[0:4194304],B[0:4194304],x[0:2048]) map(tofrom: tmp[0:2048],y[0:2048]) if(!RST_AI1)
  {
