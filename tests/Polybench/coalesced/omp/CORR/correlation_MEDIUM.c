...
#pragma omp parallel for
  ...
  || (mean + 1 > data + 262655));
  #pragma omp target data map(to: data[514:262655]) map(tofrom: mean[1:512]) if(!RST_AI1)
  {
  ...
  // Determine standard deviations of column vectors of data matrix.
  char RST_AI2 = 0;
  RST_AI2 |= !((data + 514 > mean + 512)
  || (mean + 1 > data + 262655));
  RST_AI2 |= !((data + 514 > stddev + 512)
  || (stddev + 1 > data + 262655));
  RST_AI2 |= !((mean + 1 > stddev + 512)
  || (stddev + 1 > mean + 512));
  #pragma omp target data map(to: data[514:262655],mean[1:512]) map(tofrom: stddev[1:512]) if(!RST_AI2)
  {
  ...
  // Center and reduce the column vectors.
  char RST_AI3 = 0;
  RST_AI3 |= !((data + 514 > mean + 512)
  || (mean + 1 > data + 262655));
  RST_AI3 |= !((data + 514 > stddev + 512)
  || (stddev + 1 > data + 262655));
  RST_AI3 |= !((mean + 1 > stddev + 512)
  || (stddev + 1 > mean + 512));
  #pragma omp target data map(to: mean[1:512],stddev[1:512]) map(tofrom: data[514:262655]) if(!RST_AI3)
  {
...
#pragma omp parallel for
  char RST_AI4 = 0;
  RST_AI4 |= !((data + 514 > symmat + 262654)
  || (symmat + 514 > data + 262655));
  #pragma omp target data map(to: data[514:262655]) map(tofrom: symmat[514:262654]) if(!RST_AI4)
  {
