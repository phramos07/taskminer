...
#pragma omp parallel for
  ...
  || (mean + 1 > data + 65791));
  #pragma omp target data map(to: data[258:65791]) map(tofrom: mean[1:256]) if(!RST_AI1)
  {
  ...
  || (stddev + 1 > mean + 256));
  #pragma omp target data map(to: data[258:65791],mean[1:256]) map(tofrom: stddev[1:256]) if(!RST_AI2)
  {
  ...
  || (stddev + 1 > mean + 256));
  #pragma omp target data map(to: mean[1:256],stddev[1:256]) map(tofrom: data[258:65791]) if(!RST_AI3)
  {
...
#pragma omp parallel for
  ...
  #pragma omp target data map(to: data[258:65791]) map(tofrom: symmat[258:65790]) if(!RST_AI4)
  {
