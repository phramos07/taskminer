...
void GPU__conv2D(DATA_TYPE *restrict A, DATA_TYPE *restrict B) {
  int i, j;
  DATA_TYPE c11, c12, c13, c21, c22, c23, c31, c32, c33;
...
#pragma omp parallel for
  char RST_AI1 = 0;
  RST_AI1 |= !((A + 0 > B + 99979998)
  || (B + 10001 > A + 100000000));
  #pragma omp target data map(to: A[0:100000000]) map(tofrom: B[10001:99979998]) if(!RST_AI1)
  {
