...
void GPU__mm2(DATA_TYPE *restrict A, DATA_TYPE *restrict B,
  ...
  || (C + 0 > B + 1048576));
  #pragma acc data pcopyin(A[0:1048576],B[0:1048576]) pcopy(C[0:1048576]) if(!RST_AI1)
  ...
  || (D + 0 > C + 1048576));
  RST_AI2 |= !((C + 0 > E + 1048576)
  || (E + 0 > C + 1048576));
  RST_AI2 |= !((D + 0 > E + 1048576)
  || (E + 0 > D + 1048576));
  #pragma acc data pcopyin(C[0:1048576],D[0:1048576]) pcopy(E[0:1048576]) if(!RST_AI2)
