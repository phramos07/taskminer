...
void GPU__mm2(DATA_TYPE * A, DATA_TYPE * B,
              DATA_TYPE * C, DATA_TYPE * D,
              DATA_TYPE * E) {
  int i, j;
  ...
  || (C + 0 > B + 4194304));
  #pragma acc data pcopyin(A[0:4194304],B[0:4194304]) pcopy(C[0:4194304]) if(!RST_AI1)
  ...
  || (D + 0 > C + 4194304));
  RST_AI2 |= !((C + 0 > E + 4194304)
  || (E + 0 > C + 4194304));
  RST_AI2 |= !((D + 0 > E + 4194304)
  || (E + 0 > D + 4194304));
  #pragma acc data pcopyin(C[0:4194304],D[0:4194304]) pcopy(E[0:4194304]) if(!RST_AI2)
