...
void GPU__mm2(DATA_TYPE *restrict A, DATA_TYPE *restrict B,
  ...
  || (C + 0 > B + 262144));
  #pragma acc data pcopyin(A[0:262144],B[0:262144]) pcopy(C[0:262144]) if(!RST_AI1)
  ...
  || (D + 0 > C + 262144));
  RST_AI2 |= !((C + 0 > E + 262144)
  || (E + 0 > C + 262144));
  RST_AI2 |= !((D + 0 > E + 262144)
  || (E + 0 > D + 262144));
  #pragma acc data pcopyin(C[0:262144],D[0:262144]) pcopy(E[0:262144]) if(!RST_AI2)
