...
void GPU__bicg(DATA_TYPE *restrict A, DATA_TYPE *restrict r,
  ...
  RST_AI2 |= !((r + 0 > s + 256)
  || (s + 0 > r + 256));
  #pragma acc data pcopyin(A[0:65536],r[0:256]) pcopy(s[0:256]) if(!RST_AI2)
  ...
  RST_AI3 |= !((p + 0 > q + 256)
  || (q + 0 > p + 256));
  #pragma acc data pcopyin(A[0:65536],p[0:256]) pcopy(q[0:256]) if(!RST_AI3)
