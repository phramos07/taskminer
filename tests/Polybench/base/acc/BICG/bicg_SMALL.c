...
void GPU__bicg(DATA_TYPE *restrict A, DATA_TYPE *restrict r,
  ...
  RST_AI2 |= !((r + 0 > s + 512)
  || (s + 0 > r + 512));
  #pragma acc data pcopyin(A[0:262144],r[0:512]) pcopy(s[0:512]) if(!RST_AI2)
  ...
  RST_AI3 |= !((p + 0 > q + 512)
  || (q + 0 > p + 512));
  #pragma acc data pcopyin(A[0:262144],p[0:512]) pcopy(q[0:512]) if(!RST_AI3)
