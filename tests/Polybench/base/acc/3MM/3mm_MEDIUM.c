...
/* E := A*B */
  ...
  || (E + 0 > B + 262144));
  #pragma acc data pcopyin(A[0:262144],B[0:262144]) pcopy(E[0:262144]) if(!RST_AI1)
...
/* F := C*D */
  ...
  || (F + 0 > D + 262144));
  #pragma acc data pcopyin(C[0:262144],D[0:262144]) pcopy(F[0:262144]) if(!RST_AI2)
...
/* G := E*F */
  ...
  || (G + 0 > F + 262144));
  #pragma acc data pcopyin(E[0:262144],F[0:262144]) pcopy(G[0:262144]) if(!RST_AI3)
