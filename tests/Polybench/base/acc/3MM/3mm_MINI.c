...
/* E := A*B */
  ...
  RST_AI1 |= !((B + 0 > E + 1024)
  || (E + 0 > B + 1024));
  #pragma acc data pcopyin(A[0:1024],B[0:1024]) pcopy(E[0:1024]) if(!RST_AI1)
...
/* F := C*D */
  ...
  RST_AI2 |= !((D + 0 > F + 1024)
  || (F + 0 > D + 1024));
  #pragma acc data pcopyin(C[0:1024],D[0:1024]) pcopy(F[0:1024]) if(!RST_AI2)
...
/* G := E*F */
  ...
  RST_AI3 |= !((F + 0 > G + 1024)
  || (G + 0 > F + 1024));
  #pragma acc data pcopyin(E[0:1024],F[0:1024]) pcopy(G[0:1024]) if(!RST_AI3)
