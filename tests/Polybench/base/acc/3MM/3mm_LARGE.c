...
/* E := A*B */
  ...
  || (E + 0 > B + 1048576));
  #pragma acc data pcopyin(A[0:1048576],B[0:1048576]) pcopy(E[0:1048576]) if(!RST_AI1)
...
/* F := C*D */
  ...
  || (F + 0 > D + 1048576));
  #pragma acc data pcopyin(C[0:1048576],D[0:1048576]) pcopy(F[0:1048576]) if(!RST_AI2)
...
/* G := E*F */
  ...
  || (G + 0 > F + 1048576));
  #pragma acc data pcopyin(E[0:1048576],F[0:1048576]) pcopy(G[0:1048576]) if(!RST_AI3)
