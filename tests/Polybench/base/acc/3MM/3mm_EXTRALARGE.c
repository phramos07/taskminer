...
void compareResults(DATA_TYPE * G,
...
void mm3_cpu(DATA_TYPE * A, DATA_TYPE * B,
             DATA_TYPE * C, DATA_TYPE * D,
             DATA_TYPE * E, DATA_TYPE * F,
             DATA_TYPE * G) {
  int i, j, k;
...
void GPU__mm3(DATA_TYPE * A, DATA_TYPE * B,
              DATA_TYPE * C, DATA_TYPE * D,
              DATA_TYPE * E, DATA_TYPE * F,
              DATA_TYPE * G) {
  int i, j, k;
...
/* E := A*B */
  ...
  || (E + 0 > B + 4194304));
  #pragma acc data pcopyin(A[0:4194304],B[0:4194304]) pcopy(E[0:4194304]) if(!RST_AI1)
...
/* F := C*D */
  char RST_AI2 = 0;
  RST_AI2 |= !((C + 0 > D + 4194304)
  || (D + 0 > C + 4194304));
  RST_AI2 |= !((C + 0 > F + 4194304)
  || (F + 0 > C + 4194304));
  RST_AI2 |= !((D + 0 > F + 4194304)
  || (F + 0 > D + 4194304));
  #pragma acc data pcopyin(C[0:4194304],D[0:4194304]) pcopy(F[0:4194304]) if(!RST_AI2)
...
/* G := E*F */
  char RST_AI3 = 0;
  RST_AI3 |= !((E + 0 > F + 4194304)
  || (F + 0 > E + 4194304));
  RST_AI3 |= !((E + 0 > G + 4194304)
  || (G + 0 > E + 4194304));
  RST_AI3 |= !((F + 0 > G + 4194304)
  || (G + 0 > F + 4194304));
  #pragma acc data pcopyin(E[0:4194304],F[0:4194304]) pcopy(G[0:4194304]) if(!RST_AI3)
