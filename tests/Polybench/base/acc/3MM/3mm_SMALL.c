...
/* E := A*B */
  ...
  RST_AI1 |= !((B + 0 > E + 16384)
  || (E + 0 > B + 16384));
  #pragma acc data pcopyin(A[0:16384],B[0:16384]) pcopy(E[0:16384]) if(!RST_AI1)
...
/* F := C*D */
  ...
  RST_AI2 |= !((D + 0 > F + 16384)
  || (F + 0 > D + 16384));
  #pragma acc data pcopyin(C[0:16384],D[0:16384]) pcopy(F[0:16384]) if(!RST_AI2)
...
/* G := E*F */
  ...
  RST_AI3 |= !((F + 0 > G + 16384)
  || (G + 0 > F + 16384));
  #pragma acc data pcopyin(E[0:16384],F[0:16384]) pcopy(G[0:16384]) if(!RST_AI3)
