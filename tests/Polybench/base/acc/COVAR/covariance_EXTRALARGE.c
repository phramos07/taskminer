...
void compareResults(DATA_TYPE * symmat,
...
void covariance(DATA_TYPE * data, DATA_TYPE * symmat,
                DATA_TYPE * mean) {
  int i, j, j1, j2;
...
void GPU__covariance(DATA_TYPE * data, DATA_TYPE * symmat,
                     DATA_TYPE * mean) {
  int i, j, j1, j2;
...
/* Center the column vectors. */
  ...
  || (mean + 1 > data + 4196351));
  #pragma acc data pcopyin(mean[1:2048]) pcopy(data[2050:4196351]) if(!RST_AI2)
...
/* Calculate the m * m covariance matrix. */
  char RST_AI3 = 0;
  RST_AI3 |= !((data + 2050 > symmat + 4196351)
  || (symmat + 2050 > data + 4196351));
  #pragma acc data pcopyin(data[2050:4196351]) pcopy(symmat[2050:4196351]) if(!RST_AI3)
