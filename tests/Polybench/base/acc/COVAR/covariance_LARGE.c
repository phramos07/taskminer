...
/* Center the column vectors. */
  ...
  || (mean + 1 > data + 1049599));
  #pragma acc data pcopyin(mean[1:1024]) pcopy(data[1026:1049599]) if(!RST_AI2)
...
/* Calculate the m * m covariance matrix. */
  char RST_AI3 = 0;
  RST_AI3 |= !((data + 1026 > symmat + 1049599)
  || (symmat + 1026 > data + 1049599));
  #pragma acc data pcopyin(data[1026:1049599]) pcopy(symmat[1026:1049599]) if(!RST_AI3)
