...
void GPU__atax(DATA_TYPE *restrict A, DATA_TYPE *restrict x,
  ...
  RST_AI2 |= !((tmp + 0 > x + 256)
  || (x + 0 > tmp + 256));
  #pragma acc data pcopyin(A[0:65536],x[0:256]) pcopy(tmp[0:256]) if(!RST_AI2)
...
// Note that the Loop has been reversed
  ...
  RST_AI3 |= !((tmp + 0 > y + 256)
  || (y + 0 > tmp + 256));
  #pragma acc data pcopyin(A[0:65536],tmp[0:256]) pcopy(y[0:256]) if(!RST_AI3)
