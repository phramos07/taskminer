...
void GPU__atax(DATA_TYPE *restrict A, DATA_TYPE *restrict x,
  ...
  RST_AI2 |= !((tmp + 0 > x + 512)
  || (x + 0 > tmp + 512));
  #pragma acc data pcopyin(A[0:262144],x[0:512]) pcopy(tmp[0:512]) if(!RST_AI2)
...
// Note that the Loop has been reversed
  ...
  RST_AI3 |= !((tmp + 0 > y + 512)
  || (y + 0 > tmp + 512));
  #pragma acc data pcopyin(A[0:262144],tmp[0:512]) pcopy(y[0:512]) if(!RST_AI3)
