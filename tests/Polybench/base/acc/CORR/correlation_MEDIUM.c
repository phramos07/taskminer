...
// Determine mean of column vectors of input data matrix
  ...
  || (mean + 1 > data + 262655));
  #pragma acc data pcopyin(data[514:262655]) pcopy(mean[1:512]) if(!RST_AI1)
  ...
  || (stddev + 1 > mean + 512));
  #pragma acc data pcopyin(data[514:262655],mean[1:512]) pcopy(stddev[1:512]) if(!RST_AI2)
  ...
  || (stddev + 1 > mean + 512));
  #pragma acc data pcopyin(mean[1:512],stddev[1:512]) pcopy(data[514:262655]) if(!RST_AI3)
...
// Calculate the m * m correlation matrix.
  ...
  #pragma acc data pcopyin(data[514:262655]) pcopy(symmat[514:262654]) if(!RST_AI4)
