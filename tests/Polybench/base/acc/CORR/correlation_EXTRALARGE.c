...
// Determine mean of column vectors of input data matrix
  ...
  || (mean + 1 > data + 4196351));
  #pragma acc data pcopyin(data[2050:4196351]) pcopy(mean[1:2048]) if(!RST_AI1)
  ...
  || (stddev + 1 > mean + 2048));
  #pragma acc data pcopyin(data[2050:4196351],mean[1:2048]) pcopy(stddev[1:2048]) if(!RST_AI2)
  ...
  || (stddev + 1 > mean + 2048));
  #pragma acc data pcopyin(mean[1:2048],stddev[1:2048]) pcopy(data[2050:4196351]) if(!RST_AI3)
...
// Calculate the m * m correlation matrix.
  ...
  #pragma acc data pcopyin(data[2050:4196351]) pcopy(symmat[2050:4196350]) if(!RST_AI4)
