...
// Determine mean of column vectors of input data matrix
  ...
  || (mean + 1 > data + 1049599));
  #pragma acc data pcopyin(data[1026:1049599]) pcopy(mean[1:1024]) if(!RST_AI1)
  ...
  || (stddev + 1 > mean + 1024));
  #pragma acc data pcopyin(data[1026:1049599],mean[1:1024]) pcopy(stddev[1:1024]) if(!RST_AI2)
  ...
  || (stddev + 1 > mean + 1024));
  #pragma acc data pcopyin(mean[1:1024],stddev[1:1024]) pcopy(data[1026:1049599]) if(!RST_AI3)
...
// Calculate the m * m correlation matrix.
  ...
  #pragma acc data pcopyin(data[1026:1049599]) pcopy(symmat[1026:1049598]) if(!RST_AI4)
