...
#pragma omp parallel for
  ...
  RST_AI1 |= !((B + 0 > C + 1024)
  || (C + 0 > B + 1024));
  #pragma omp target data map(to: A[0:1024],B[0:1024]) map(tofrom: C[0:1024]) if(!RST_AI1)
...
#pragma omp parallel for
  ...
  RST_AI2 |= !((D + 0 > E + 1024)
  || (E + 0 > D + 1024));
  #pragma omp target data map(to: C[0:1024],D[0:1024]) map(tofrom: E[0:1024]) if(!RST_AI2)
