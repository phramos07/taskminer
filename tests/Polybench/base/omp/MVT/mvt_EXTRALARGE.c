...
#pragma omp parallel for collapse(1)
  ...
  || (y1 + 0 > x1 + 4096));
  #pragma omp target data map(to: a[0:16777216],y1[0:4096]) map(tofrom: x1[0:4096]) if(!RST_AI1)
...
#pragma omp parallel for collapse(1)
  ...
  || (y2 + 0 > x2 + 4096));
  #pragma omp target data map(to: a[0:16777216],y2[0:4096]) map(tofrom: x2[0:4096]) if(!RST_AI2)
