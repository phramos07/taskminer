...
#pragma omp parallel for collapse(1)
  ...
  RST_AI1 |= !((x1 + 0 > y1 + 512)
  || (y1 + 0 > x1 + 512));
  #pragma omp target data map(to: a[0:262144],y1[0:512]) map(tofrom: x1[0:512]) if(!RST_AI1)
...
#pragma omp parallel for collapse(1)
  ...
  RST_AI2 |= !((x2 + 0 > y2 + 512)
  || (y2 + 0 > x2 + 512));
  #pragma omp target data map(to: a[0:262144],y2[0:512]) map(tofrom: x2[0:512]) if(!RST_AI2)
