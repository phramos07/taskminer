...
#pragma omp parallel for collapse(1)
  ...
  RST_AI1 |= !((x1 + 0 > y1 + 256)
  || (y1 + 0 > x1 + 256));
  #pragma omp target data map(to: a[0:65536],y1[0:256]) map(tofrom: x1[0:256]) if(!RST_AI1)
...
#pragma omp parallel for collapse(1)
  ...
  RST_AI2 |= !((x2 + 0 > y2 + 256)
  || (y2 + 0 > x2 + 256));
  #pragma omp target data map(to: a[0:65536],y2[0:256]) map(tofrom: x2[0:256]) if(!RST_AI2)
