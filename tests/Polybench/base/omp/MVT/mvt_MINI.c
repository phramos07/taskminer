...
#pragma omp parallel for collapse(1)
  ...
  RST_AI1 |= !((x1 + 0 > y1 + 128)
  || (y1 + 0 > x1 + 128));
  #pragma omp target data map(to: a[0:16384],y1[0:128]) map(tofrom: x1[0:128]) if(!RST_AI1)
...
#pragma omp parallel for collapse(1)
  ...
  RST_AI2 |= !((x2 + 0 > y2 + 128)
  || (y2 + 0 > x2 + 128));
  #pragma omp target data map(to: a[0:16384],y2[0:128]) map(tofrom: x2[0:128]) if(!RST_AI2)
