...
#pragma omp parallel for collapse(2)
  ...
  || (mean + 1 > data + 65791));
  #pragma omp target data map(to: mean[1:256]) map(tofrom: data[258:65791]) if(!RST_AI2)
...
#pragma omp parallel for collapse(2)
  char RST_AI3 = 0;
  RST_AI3 |= !((data + 258 > symmat + 65791)
  || (symmat + 258 > data + 65791));
  #pragma omp target data map(to: data[258:65791]) map(tofrom: symmat[258:65791]) if(!RST_AI3)
