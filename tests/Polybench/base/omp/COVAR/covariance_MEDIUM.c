...
#pragma omp parallel for collapse(2)
  ...
  || (mean + 1 > data + 262655));
  #pragma omp target data map(to: mean[1:512]) map(tofrom: data[514:262655]) if(!RST_AI2)
...
#pragma omp parallel for collapse(2)
  char RST_AI3 = 0;
  RST_AI3 |= !((data + 514 > symmat + 262655)
  || (symmat + 514 > data + 262655));
  #pragma omp target data map(to: data[514:262655]) map(tofrom: symmat[514:262655]) if(!RST_AI3)
