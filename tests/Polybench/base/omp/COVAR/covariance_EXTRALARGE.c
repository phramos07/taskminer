...
#pragma omp parallel for collapse(2)
  ...
  || (mean + 1 > data + 4196351));
  #pragma omp target data map(to: mean[1:2048]) map(tofrom: data[2050:4196351]) if(!RST_AI2)
...
#pragma omp parallel for collapse(2)
  ...
  #pragma omp target data map(to: data[2050:4196351]) map(tofrom: symmat[2050:4196351]) if(!RST_AI3)
