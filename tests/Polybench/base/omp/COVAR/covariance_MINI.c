...
#pragma omp parallel for collapse(2)
  ...
  || (mean + 1 > data + 16511));
  #pragma omp target data map(to: mean[1:128]) map(tofrom: data[130:16511]) if(!RST_AI2)
...
#pragma omp parallel for collapse(2)
  char RST_AI3 = 0;
  RST_AI3 |= !((data + 130 > symmat + 16511)
  || (symmat + 130 > data + 16511));
  #pragma omp target data map(to: data[130:16511]) map(tofrom: symmat[130:16511]) if(!RST_AI3)
