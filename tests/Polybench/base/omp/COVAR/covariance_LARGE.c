...
#pragma omp parallel for collapse(2)
  ...
  || (mean + 1 > data + 1049599));
  #pragma omp target data map(to: mean[1:1024]) map(tofrom: data[1026:1049599]) if(!RST_AI2)
...
#pragma omp parallel for collapse(2)
  ...
  #pragma omp target data map(to: data[1026:1049599]) map(tofrom: symmat[1026:1049599]) if(!RST_AI3)
