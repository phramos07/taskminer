...
#pragma omp parallel for
  ...
  RST_AI1 |= !((B + 0 > E + 16384)
  || (E + 0 > B + 16384));
  #pragma omp target data map(to: A[0:16384],B[0:16384]) map(tofrom: E[0:16384]) if(!RST_AI1)
...
#pragma omp parallel for
  ...
  RST_AI2 |= !((D + 0 > F + 16384)
  || (F + 0 > D + 16384));
  #pragma omp target data map(to: C[0:16384],D[0:16384]) map(tofrom: F[0:16384]) if(!RST_AI2)
...
#pragma omp parallel for
  ...
  RST_AI3 |= !((F + 0 > G + 16384)
  || (G + 0 > F + 16384));
  #pragma omp target data map(to: E[0:16384],F[0:16384]) map(tofrom: G[0:16384]) if(!RST_AI3)
