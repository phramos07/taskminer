...
#pragma omp parallel for
  ...
  || (E + 0 > B + 1048576));
  #pragma omp target data map(to: A[0:1048576],B[0:1048576]) map(tofrom: E[0:1048576]) if(!RST_AI1)
...
#pragma omp parallel for
  char RST_AI2 = 0;
  RST_AI2 |= !((C + 0 > D + 1048576)
  || (D + 0 > C + 1048576));
  RST_AI2 |= !((C + 0 > F + 1048576)
  || (F + 0 > C + 1048576));
  RST_AI2 |= !((D + 0 > F + 1048576)
  || (F + 0 > D + 1048576));
  #pragma omp target data map(to: C[0:1048576],D[0:1048576]) map(tofrom: F[0:1048576]) if(!RST_AI2)
...
#pragma omp parallel for
  char RST_AI3 = 0;
  RST_AI3 |= !((E + 0 > F + 1048576)
  || (F + 0 > E + 1048576));
  RST_AI3 |= !((E + 0 > G + 1048576)
  || (G + 0 > E + 1048576));
  RST_AI3 |= !((F + 0 > G + 1048576)
  || (G + 0 > F + 1048576));
  #pragma omp target data map(to: E[0:1048576],F[0:1048576]) map(tofrom: G[0:1048576]) if(!RST_AI3)
