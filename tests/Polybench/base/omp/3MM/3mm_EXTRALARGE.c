...
#pragma omp parallel for
  ...
  || (E + 0 > B + 4194304));
  #pragma omp target data map(to: A[0:4194304],B[0:4194304]) map(tofrom: E[0:4194304]) if(!RST_AI1)
...
#pragma omp parallel for
  ...
  || (F + 0 > D + 4194304));
  #pragma omp target data map(to: C[0:4194304],D[0:4194304]) map(tofrom: F[0:4194304]) if(!RST_AI2)
...
#pragma omp parallel for
  ...
  || (G + 0 > F + 4194304));
  #pragma omp target data map(to: E[0:4194304],F[0:4194304]) map(tofrom: G[0:4194304]) if(!RST_AI3)
