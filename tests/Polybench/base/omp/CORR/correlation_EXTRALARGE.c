...
#pragma omp parallel for
  ...
  || (mean + 1 > data + 4196351));
  #pragma omp target data map(to: data[2050:4196351]) map(tofrom: mean[1:2048]) if(!RST_AI1)
  ...
  // Determine standard deviations of column vectors of data matrix.
  char RST_AI2 = 0;
  RST_AI2 |= !((data + 2050 > mean + 2048)
  || (mean + 1 > data + 4196351));
  RST_AI2 |= !((data + 2050 > stddev + 2048)
  || (stddev + 1 > data + 4196351));
  RST_AI2 |= !((mean + 1 > stddev + 2048)
  || (stddev + 1 > mean + 2048));
  #pragma omp target data map(to: data[2050:4196351],mean[1:2048]) map(tofrom: stddev[1:2048]) if(!RST_AI2)
  ...
  // Center and reduce the column vectors.
  char RST_AI3 = 0;
  RST_AI3 |= !((data + 2050 > mean + 2048)
  || (mean + 1 > data + 4196351));
  RST_AI3 |= !((data + 2050 > stddev + 2048)
  || (stddev + 1 > data + 4196351));
  RST_AI3 |= !((mean + 1 > stddev + 2048)
  || (stddev + 1 > mean + 2048));
  #pragma omp target data map(to: mean[1:2048],stddev[1:2048]) map(tofrom: data[2050:4196351]) if(!RST_AI3)
...
#pragma omp parallel for
  char RST_AI4 = 0;
  RST_AI4 |= !((data + 2050 > symmat + 4196350)
  || (symmat + 2050 > data + 4196351));
  #pragma omp target data map(to: data[2050:4196351]) map(tofrom: symmat[2050:4196350]) if(!RST_AI4)
