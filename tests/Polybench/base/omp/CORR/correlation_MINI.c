...
#pragma omp parallel for
  ...
  || (mean + 1 > data + 16511));
  #pragma omp target data map(to: data[130:16511]) map(tofrom: mean[1:128]) if(!RST_AI1)
  ...
  // Determine standard deviations of column vectors of data matrix.
  char RST_AI2 = 0;
  RST_AI2 |= !((data + 130 > mean + 128)
  || (mean + 1 > data + 16511));
  RST_AI2 |= !((data + 130 > stddev + 128)
  || (stddev + 1 > data + 16511));
  RST_AI2 |= !((mean + 1 > stddev + 128)
  || (stddev + 1 > mean + 128));
  #pragma omp target data map(to: data[130:16511],mean[1:128]) map(tofrom: stddev[1:128]) if(!RST_AI2)
  ...
  // Center and reduce the column vectors.
  char RST_AI3 = 0;
  RST_AI3 |= !((data + 130 > mean + 128)
  || (mean + 1 > data + 16511));
  RST_AI3 |= !((data + 130 > stddev + 128)
  || (stddev + 1 > data + 16511));
  RST_AI3 |= !((mean + 1 > stddev + 128)
  || (stddev + 1 > mean + 128));
  #pragma omp target data map(to: mean[1:128],stddev[1:128]) map(tofrom: data[130:16511]) if(!RST_AI3)
...
#pragma omp parallel for
  char RST_AI4 = 0;
  RST_AI4 |= !((data + 130 > symmat + 16510)
  || (symmat + 130 > data + 16511));
  #pragma omp target data map(to: data[130:16511]) map(tofrom: symmat[130:16510]) if(!RST_AI4)
