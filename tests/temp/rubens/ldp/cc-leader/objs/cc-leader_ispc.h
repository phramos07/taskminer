//
// objs/cc-leader_ispc.h
// (Header automatically generated by the ispc compiler.)
// DO NOT EDIT THIS FILE.
//

#ifndef ISPC_OBJS_CC_LEADER_ISPC_H
#define ISPC_OBJS_CC_LEADER_ISPC_H
...
extern "C" {
    ...
    extern void graph_cc_leader(int32_t * rank, struct Graph &graph);
    extern void graph_cc_leader_lch(int32_t * rank, struct Graph &graph);
    extern void graph_cc_leader_par(int32_t * rank, struct Graph &graph);
...
#endif // ISPC_OBJS_CC_LEADER_ISPC_H
