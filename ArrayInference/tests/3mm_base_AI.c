...
void init_array(DATA_TYPE *restrict A, DATA_TYPE *restrict B,
  ...
  || (D + 0 > C + 4194304));
  #pragma acc data pcopy(A[0:4194304],B[0:4194304],C[0:4194304],D[0:4194304]) if(!RST_AI1)
  {
...
void mm3_cpu(DATA_TYPE *restrict A, DATA_TYPE *restrict B,
  ...
  || (G + 0 > F + 4194304));
  #pragma acc data pcopyin(A[0:4194304],B[0:4194304],C[0:4194304],D[0:4194304]) pcopy(E[0:4194304],F[0:4194304],G[0:4194304]) if(!RST_AI1)
  {
  #pragma acc kernels if(!RST_AI1)
  for (i = 0; i < NI; i++) {
    for (j = 0; j < NJ; j++) {
