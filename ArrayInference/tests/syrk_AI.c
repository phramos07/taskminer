...
void init_arrays(DATA_TYPE *restrict A, DATA_TYPE *restrict C,
  ...
  || (C + 0 > A + 5760000));
  RST_AI1 |= !((A + 0 > D + 5760000)
  || (D + 0 > A + 5760000));
  RST_AI1 |= !((C + 0 > D + 5760000)
  || (D + 0 > C + 5760000));
  #pragma acc data pcopy(A[0:5760000],C[0:5760000],D[0:5760000]) if(!RST_AI1)
  {
...
void compareResults(DATA_TYPE *restrict C, DATA_TYPE *restrict D) {
  ...
  RST_AI1 |= !((C + 0 > D + 5760000)
  || (D + 0 > C + 5760000));
  #pragma acc data pcopyin(C[0:5760000],D[0:5760000])  if(!RST_AI1)
  {
  #pragma acc kernels if(!RST_AI1)
  for (i = 0; i < N; i++) {
    for (j = 0; j < M; j++) {
...
void syrk(DATA_TYPE *restrict A, DATA_TYPE *restrict C) {
  ...
  RST_AI1 |= !((A + 0 > C + 5760000)
  || (C + 0 > A + 5760000));
  #pragma acc data pcopyin(A[0:5760000]) pcopy(C[0:5760000]) if(!RST_AI1)
  {
  #pragma acc kernels if(!RST_AI1)
  for (i = 0; i < N; i++) {
    for (j = 0; j < M; j++) {
...
#pragma acc loop independent
  #pragma acc data pcopy(D[0:5760000])
  {
  #pragma acc kernels if(!RST_AI1)
  for (i = 0; i < N; i++) {
    for (j = 0; j < M; j++) {
...
#pragma acc loop independent
  ...
  || (D + 0 > A + 5760000));
  #pragma acc data pcopyin(A[0:5760000]) pcopy(D[0:5760000]) if(!RST_AI2)
  {
