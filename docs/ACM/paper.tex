...
\authornote{This work is sponsored by CNPq, CAPEs, FAPEMIG, FAPESP, LG Electronics and
the CONTINUUM ANR Project.}          %% \authornote is optional;
%\orcid{nnnn-nnnn-nnnn-nnnn}
\affiliation{
%  \position{Professor}
%  \department{DCC}
  \institution{UFMG, Brazil \& LIRMM, France}
%  \streetaddress{6627 Antonio Carlos Avenue}
%  \city{Belo Horizonte}
%  \state{Minas Gerais}
%  \postcode{31.270-213}
