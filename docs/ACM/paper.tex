...
\begin{figure}[h]
\begin{center}
\includegraphics[width=1.1\columnwidth]{images/EVAL1_bots_and_toys.png}
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=1\columnwidth]{images/EVAL2_opt.png}
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=1\columnwidth]{images/EVAL3_test-suite.png}
