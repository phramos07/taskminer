...
their sequential --unannotated-- versions, as we report in
...
\Taskminer{} against either the original program (the baseline,
...
instructions in the 30 largest benchmarks that we analyze.
