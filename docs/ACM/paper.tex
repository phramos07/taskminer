...
%% Supplied to authors by publisher for camera-ready submission
\acmConference[PACT]{ACM}{2018}{Limassol, Cyprus}
\acmYear{2017}
...
\title[Automatic Annotation of Tasks in Structured Code]
{Automatic Annotation of Tasks in Structured Code}

\author{Pedro Ramos, Gleison Souza}
...
\author{Divino Soares, Guido Ara\'{u}jo}
...
\authornote{This work is sponsored by CNPq, CAPEs, FAPEMIG, FAPESP, ANR and LG Electronics.
While working on this project, Fernando was supported by a grant from the CONTINUUM ANR
Project (ANR-15-CE25-0007-0).}          %% \authornote is optional;
%\orcid{nnnn-nnnn-nnnn-nnnn}
\affiliation{
%  \position{Professor}
%  \department{DCC}
...
\begin{definition}[Program Dependence Graph (PDG)~\cite{Ferrante87}]
\label{def:pdg}
...
\noindent
\textbf{Software}:
\Taskminer{} can be used directly through an online interface available at
\url{http://cuda.dcc.ufmg.br/taskminer/}
